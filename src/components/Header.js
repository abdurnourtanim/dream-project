...
const Header = () => {
  return (
    <div className="container bg-gray-100 dark:bg-gray-800 rounded-t-lg flex flex-col-reverse items-center px-5 mx-auto pt-20 md:pt-28 space-y-0 md:space-y-0 md:flex-row">
      {/* content  */}
      <div className="flex flex-col mt-5 md:mt-10  space-y-12 md:w-1/2">
